...
const signals: TrendSignal[] = [
  {
    ...
    direction: "up",
    deltaPct: 42,
    trigger: "Pico em SE 14 com 8 confirmados; alta sustentada em São Luís",
    category: "vigilancia",
    priority: "alta",
  ...
  },
  {
    ...
    direction: "up",
    deltaPct: 33,
    trigger: "27% dos confirmados concentrados em < 1 ano (12 casos)",
    category: "imunizacao",
    priority: "alta",
  ...
  },
  {
    ...
    direction: "up",
    deltaPct: 100,
    trigger: "12 óbitos confirmados em 2026 — letalidade de 27%",
  ...
  {
    id: "response-time",
    label: "Casos em aberto persistentes",
    metric: "Tempo médio encerramento",
    direction: "up",
    deltaPct: 12,
    trigger: "49 casos em aberto (40% do total notificado)",
    category: "operacional",
    priority: "alta",
    action: "Acelerar encerramento dos casos em aberto.",
  },
  {
    id: "bacterial-share",
    ...
    direction: "up",
    deltaPct: 5,
    trigger: "80% das confirmações são bacterianas (35 de 44)",
    category: "imunizacao",
    priority: "alta",
  ...
  },
  {
    ...
    direction: "up",
    deltaPct: 8,
    trigger: "36% dos notificados seguem em investigação (43 casos)",
    category: "operacional",
    priority: "media",
  ...
  },
  {
    ...
    direction: "up",
    deltaPct: 12,
    trigger: "9 casos > 60 dias sem encerramento",
    category: "vigilancia",
    priority: "media",
    action: "Reforçar busca ativa nas regionais com pendências.",
  },
  {
    id: "lethality-up",
    label: "Letalidade em alta",
    metric: "Taxa de letalidade",
    direction: "up",
    deltaPct: 27,
    trigger: "Letalidade subiu para 27% (12 óbitos / 44 confirmados)",
    category: "assistencia",
    priority: "alta",
    action: "Revisar protocolo clínico hospitalar de meningite.",
  },
];
